  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-100 overflow-x-hidden pt-14">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-gray-400 mb-8">Review your mentoring sessions and track student progress</p>
              ...
              <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-4">
                      <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 rounded-full bg-gray-700 flex items-center justify-center text-white font-semibold">
                          {sessionInfo.studentName?.charAt(0) || 'S'}
                        </div>
                        <div>
                          <p className="text-white font-medium">Session with {sessionInfo.studentName}</p>
                ...
                <div className="bg-[#121212] rounded-xl border border-gray-800 p-5">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-white">Student Action Items</h3>
                  </div>
                  <ul className="space-y-3">
                ...
                <div className="bg-[#121212] rounded-xl border border-gray-800 p-5">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-white">Mentor Notes</h3>
                  </div>
                  <div className="space-y-4">
                    {insights.reflectionQuestions?.map((question, index) => (
                      <div key={index} className="bg-[#1a1a1a] rounded-lg p-4">
                        ...
                        <textarea 
                          placeholder="Add your notes for this student..."
        ...
        {!fromSession && (
          <div className="bg-[#121212] rounded-xl border border-gray-800 p-8 text-center">
            ...
            <p className="text-gray-400 mb-6">
              After completing a mentoring session, you'll be redirected here to review AI-powered insights and add notes about your student's progress.
            </p>
            <button 
              onClick={() => navigate('/mentor/mentees')}
              className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors"
